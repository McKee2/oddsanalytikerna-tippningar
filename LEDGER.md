# LEDGER — frusna tippningar mot facit

Vår frusna tippning ställs mot facit, match för match. Tippningarna ändras **aldrig**
i efterhand — bara facit-kolumnen fylls i när matchen spelats. Missar visas lika
tydligt som träffar. Det riktiga beviset är filerna i [`previews/`](previews/) —
den här sammanfattningen är genererad.

**3 av 3 avgjorda rätt** (100%). Ännu ej spelade: 0.

| Match | Marknad | När (svensk tid) | Vår tippning (pick · odds · ★confidence · frusen) | Facit | Utfall |
| --- | --- | --- | --- | --- | --- |
| [Kanada–Bosnien-Hercegovina](previews/kanada-vs-bosnien-hercegovina.ts) | Mål över/under 2,5 | fre 12 juni 2026, 21:00 | Under 2,5 mål @ 1,68 · ★3 · 9 juni 2026 · modell Kanada 1 – Bosnien-Hercegovina 0 | 2 mål → Under 2,5 | ✓ Rätt |
| [Mexiko–Sydafrika](previews/mexiko-vs-sydafrika.ts) | Mål över/under 2,5 | tors 11 juni 2026, 21:00 | Under 2,5 mål @ 1,77 · ★3 · 8 juni 2026 · modell Mexiko 1 – Sydafrika 0 | 2 mål → Under 2,5 | ✓ Rätt |
| [Sverige–Tunisien](previews/tunisien-vs-sverige.ts) | Matchvinnare (1X2) | mån 15 juni 2026, 04:00 | Sverige · ★3 · 7 juni 2026 · modell Sverige 2 – Tunisien 1 | 5–1 (Hemmaseger) | ✓ Rätt |
...
Hela sluttabellen 1–20 + nyckelpicks, frusen **17 juli 2026**. Beviset är filen
[`premierleague/prognos-2026-27.ts`](premierleague/prognos-2026-27.ts) — den ändras aldrig
efter frysning. Facit fylls i när säsongen är färdigspelad (maj 2027).

| Pick | Vår tippning | Facit |
| --- | --- | --- |
| Mästare | Manchester City | Ej avgjort ännu |
| Topp 4 | Manchester City · Liverpool · Arsenal · Aston Villa | Ej avgjort ännu |
| Nedflyttning | Coventry City · Ipswich Town · Hull City | Ej avgjort ännu |
